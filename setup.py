...
class BuildExe:
    def __init__(self):
        ...
        #Project url
        self.project_url = "https://www.github.com/pywareCode/Taco-Chronicles"
        ...
        self.extra_datass = ['Buildings//Apt1.png', 'Buildings//Apt2.png', 'Buildings//Apt3.png', 'Buildings//Apt4.png', 'Buildings//BananaBees.gif',
                            ...
                            'Characters//DrTacoWalkRight.gif', 'Characters//officerRight.gif', 'Characters//officerWalkRight.gif', 'powerups//ammoBox.png',
                            'powerups//healthBox.png', 'powerups//taco.png', 'fonts//font.ttf', 'sound//flame.wav', 'sound//gunshot.wav', 'sound//gameTheme.mp3',
                            'sound//gunClick.wav', 'sound//munch.wav', 'sound//rocket.wav', 'sound//powerupSound.wav', 'Tools//crowbar.gif', 'Tools//jetpack.png',
                            'Tools//TNT.png', 'Tools//key.gif', 'Tools//rope.gif', 'Weapons//9mmRight.gif', 'Weapons//shotgun.gif', 'Weapons//flamethrower.gif',
                            'Weapons//bazooka.gif', 'Weapons//AK-47.gif', 'Weapons//lock.gif', 'Weapons//rocket.png', 'Weapons//flame.png', 'data.p']
 
        #Extra/excludes python modules
        self.extra_modules = ['pygame', 'wx']
        self.exclude_modules = []
        
        #DLL Excludes
        self.exclude_dll = ['MSVCP90.dll']
        #python scripts (strings) to be included, seperated by a comma
        self.extra_scripts = ['background', 'baddieAI', 'button', 'file', 'installer', 'l1', 'load', 'person', 'popups', 'powerups',
                              'screen', 'selectGun', 'selectTool', 'toolbar']
