...
class Popups(object, Button):
    def __init__(self, window):
        ...
        #Create taco image
        self.tacoImageBIG = pygame.image.load('/home/pi/Taco-Chronicles/files/powerups/taco.png')
    ...
    def endgame(self):
        while True:
            self.tacoImage = pygame.image.load('/home/pi/Taco-Chronicles/files/Characters/blownUp.gif')
