...
'''
    def __init__(self, windowSurface, score):
        ...
        self.score = score
        self.clear = False
        self.sound = pygame.mixer.Sound('/home/pi/Taco-Chronicles/files/sound/powerupSound.wav')
        self.munch = pygame.mixer.Sound('/home/pi/Taco-Chronicles/files/sound/munch.wav')
        

    def ammoBox(self, x, y, rect, ammo, score, sound):
        self.ammoBoxImage = pygame.image.load('/home/pi/Taco-Chronicles/files/powerups/ammoBox.png')
    ...
    def taco(self, x, y, rect, sound, score, tacosCollected):
        self.tacoImage2 = pygame.image.load('/home/pi/Taco-Chronicles/files/powerups/taco.png')
    ...
    def healthBox(self, x, y, rect, health, sound, score):
        self.healthBoxImage = pygame.image.load('/home/pi/Taco-Chronicles/files/powerups/healthBox.png')
