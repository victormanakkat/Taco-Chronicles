...
class Level_2(Background):
    def  __init__(self, surface):
        ...
        self.skyscraperImage = pygame.image.load('files\\Buildings\\skyscraper.png')
        ...
        self.burgerBarnImage = pygame.image.load('files\\Buildings\\burgerBarn.png')
        ...
        self.centralParkImage = pygame.image.load('files\\Buildings\\centralPark.png')
