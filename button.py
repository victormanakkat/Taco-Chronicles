...
class Button:
    ...
    def roundButton(self, event, button, location):
        ...
        self.backImage = pygame.image.load('buttons\\back.png')
        ...
        self.soundOffImage = pygame.image.load('buttons\\soundOff.png')
        self.soundOffImageBIG = pygame.transform.scale(self.soundOffImage, (75, 75))

        #Setup pause image and rectangle
        self.pauseImage = pygame.image.load('buttons\\pause.png')
